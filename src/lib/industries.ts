...
export const industries: Industry[] = [
  ...
  // ─────────────────────────────────────────── SEED COMPANIES
  {
    ...
    seo: {
      ...
      body: [
        ...
        "OZZO doubles as field-force tracking (WFA) and salesman location tracking software for seed companies: selfie + GPS attendance, live location and geo-tagged dealer visits. So \"SFA for seed companies\", \"dealer management software for seeds\" and \"salesman tracking app\" are one system. Season-timed order booking, outstanding and collection control, and GPS field tracking make OZZO a practical seed distribution and sales-tracking system.",
      ],
  ...
  // ─────────────────────────────────────────── PAINTS
  {
    ...
    seo: {
      ...
      body: [
        ...
        "It is also field-force tracking (WFA) and salesman location tracking software for paint field teams: selfie + GPS attendance, live location and geo-tagged dealer, painter and contractor visits. So \"SFA for paint companies\", \"dealer management software for paints\" and \"salesman tracking software\" are one system. Counter order booking, painter/contractor engagement, secondary sales, trade schemes and GPS field tracking make OZZO a practical paint distribution and sales-tracking system.",
      ],
  ...
  // ─────────────────────────────────────────── ADHESIVES & CONSTRUCTION CHEMICALS
  {
    ...
    seo: {
      ...
      body: [
        ...
        "It is also field-force tracking (WFA) and salesman location tracking software for construction-chemical field teams: selfie + GPS attendance, live location and geo-tagged dealer, applicator, contractor and site visits. So \"SFA for construction chemicals\", \"dealer management software for waterproofing\" and \"salesman tracking software\" are one system. Order booking, applicator engagement, site-demo logging, project pipeline, outstanding and GPS field tracking make OZZO a practical construction-chemical distribution and sales-tracking system.",
      ],
  ...
  // ─────────────────────────────────────────── PLYWOOD & LAMINATES
  {
    ...
    seo: {
      ...
      body: [
        ...
        "It is also field-force tracking (WFA) and salesman location tracking software for plywood and laminate field teams: selfie + GPS attendance, live location and geo-tagged dealer and carpenter visits. So \"SFA for plywood companies\", \"dealer management software for laminates\" and \"salesman tracking software\" are one system. Order booking, carpenter engagement, secondary sales, trade schemes and GPS field tracking make OZZO a practical plywood and laminate distribution and sales-tracking system.",
      ],
  ...
  // ─────────────────────────────────────────── PHARMACEUTICAL (MR)
  {
    ...
    solutions: [
      ...
      { pain: "Real coverage, not reported coverage", how: "Selfie + GPS attendance, live location mean 'met the doctor' means the phone was actually there, and the whole territory gets worked in order." },
  ...
  // ─────────────────────────────────────────── AYURVEDIC & NUTRACEUTICAL
  {
    ...
    seo: {
      ...
      body: [
        ...
        "It is also field-force tracking (WFA) and salesman location tracking software for wellness field teams: selfie + GPS attendance, live location and geo-tagged retailer and practitioner visits. So \"SFA for ayurvedic companies\", \"nutraceutical distribution software\" and \"salesman tracking software\" are one system. Retail coverage, reorder and secondary visibility, schemes, expiry returns and GPS tracking make OZZO a practical ayurvedic and nutraceutical sales-tracking system.",
      ],
  ...
  // ─────────────────────────────────────────── LUBRICANTS & OILS
  {
    ...
    seo: {
      ...
      body: [
        ...
        "It is also field-force tracking (WFA) and salesman location tracking software for lubricant field teams: selfie + GPS attendance, live location and geo-tagged workshop, retailer and distributor visits. So \"SFA for lubricants\", \"lubricant dealer management software\" and \"salesman tracking software\" are one system. Multi-unit order booking, price control, workshop engagement, secondary sales and GPS tracking make OZZO a practical lubricant distribution and sales-tracking system.",
      ],
  ...
  // ─────────────────────────────────────────── BATTERIES
  {
    ...
    seo: {
      ...
      body: [
        ...
        "It is also field-force tracking (WFA) and salesman location tracking software for battery field teams: selfie + GPS attendance, live location and geo-tagged dealer and mechanic visits. So \"SFA for battery companies\", \"battery dealer management software\" and \"salesman tracking software\" are one system. Order booking, ageing-stock visibility, dealer credit and GPS field tracking make OZZO a practical battery distribution and sales-tracking system.",
      ],
